...
<div class="wrapper">
    ...
    -->
        ...
        <ul class="nav">
          ...
          <li class="active">
              <a href="personasConfianza.php">
                <i class="pe-7s-users"></i>
                <p>Personas de confianza</p>
              </a>
          </li>
          <li>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="card">
                          ...
                          <div class="header">
                              <h4 class="title">Personas de confianza</h4>
                              <p class="category">Da de alta personas de confianza que pueden recoger a tu hijo y llenar sus formatos.</p>
                          </div>
                          <hr>
                          <?php
                          ...
                          <div class="content">
                            ...
                            <p class="category">Esta sección sigue en construcción, lamentamos los inconvenientes.</p>
