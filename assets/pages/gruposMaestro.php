...
<?php
   ...
   $sqlG = "SELECT etapa,id,nombre,apellido,correo FROM grupo,usuarios WHERE correo_maestro=correo AND correo='$correo'";
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="header">
                                ...
                                <p class="category">Ve y edita algunos datos de tus grupos. También puedes mandar un mensaje a todos los padres de cierto grupo. </p>
                            </div>
                            <hr>
                            <div class="content">
                                        ...
                                        <tbody>
                                          ...
                                          //resG y resN
                                            foreach ($resG as $tupla){
                                              ...
                                              <td>
                                                <form action="gruposEditarMaestro.php" method="GET">
                    ...
                    <div class="card">
                        ...
                        <div class="content">
                          ...
                          <form method="post">
                            ...
                            <div class="form-group">
                                <label>Mensaje</label>
                                <input type="text" class="form-control" placeholder="Correo Electrónico" name="msjPriv" required>
                            </div>
                            <div class="form-group">
