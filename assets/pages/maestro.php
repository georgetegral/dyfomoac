                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Maestros registrados</h4>
                                <p class="category">Administra a cada maestro que trabaja en esta institución. </p>
                            </div>
                            <hr>
                            <div class="content">
                                ...
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                          ...
                                          $queryM = "SELECT correo,nombre,apellido FROM usuarios WHERE tipo='2' AND nombre != ''";
                                          ...
                                          foreach ($res as $tupla){
                                            ...
                                            <td><?php echo $tupla["correo"]; ?></td>
                                            <td>
                                              <form id="editM" action="maestroEditar.php" method="GET">
                                                <button type="submit" class="btn btn-info btn-fill" name="mail" value="<?php echo $tupla["correo"]; ?>">Editar</button>
                                              </form>
                                            </td>
                                            </tr>
                                            <?php
                        ...
                        if($option=="op1"){
                          ...
                          if(empty($tupla)){
                            ...
                            if(!$mail->send()) {
                                ...
                                $avisos["veri"] = "Se ha dado de alta al maestro exitosamente y se le ha enviado un correo.";

                                $sql = "INSERT INTO usuarios (correo, codigo, tipo) VALUES ('$mailPost','$string',2)";
                          ...
                          if(empty($tupla)){
                            ...
                            if(!$mail->send()) {
                              $avisos["err"] = 'Mailer Error: ' . $mail->ErrorInfo;
                                ...
                                $avisos["veri"] = "Se ha cambiado el código de verificación del maestro exitosamente y se le ha enviado un correo.";
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Agregar Maestro</h4>
                                <p class="category">Manda un correo con un código de verificación a un nuevo maestro que trabajará en esta institución.</p>
                            </div>
                            <hr>
                            <div class="content">
