...
<?php
   ...
   //Tupla ingreso
   $sqlI="SELECT DISTINCT f.fecha, m.id FROM menor AS m, formatoingreso AS f WHERE m.id=f.id_menor AND m.id='$id' ORDER BY f.fecha DESC LIMIT 5";
   ...
   //Tupla durante
   $sqlD="SELECT DISTINCT f.fecha, m.id FROM menor AS m, formatodurante AS f WHERE m.id=f.id_menor AND m.id='$id' ORDER BY f.fecha DESC LIMIT 5";
   ...
   //Tupla salida
   $sqlS="SELECT DISTINCT f.fecha, m.id FROM menor AS m, formatosalida AS f WHERE m.id=f.id_menor AND m.id='$id' ORDER BY f.fecha DESC LIMIT 5";
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
               ...
               ?>
               <h5>Se muestran los 5 reportes más recientes, para ver la lista completa hacer click en el botón de "Ver lista completa".</h5>
               <div class="col-md-4">
                   <div class="card">
                       <div class="header">
                       ...
                       <div class="content">
                         ...
                         <form method="get" action ="verFormatosCompleto.php">

                           <input type="hidden" name="tipo" value="ingreso"/>
                           <input type="hidden" name="idmenor" value="<?php echo $id; ?>"/>
                           <button type="submit" class="btn btn-info btn-fill pull-left">Ver lista completa</button>
